...
class MobilesShape extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    alignment: Alignment.topRight,child:  Row(
      ...
      children: [
        ...
        Image.asset('assets/images/mobiles.png',
  ...
  shape(){
    return  Container(
      ...
      child: Column(
        children: [
          Image.asset('assets/images/mobile.png',width:  SizeConfig.screenWidth*s60,height: 60,),
